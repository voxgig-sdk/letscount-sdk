...
from letscount_sdk.letscount_types import (
...
class CreateOrUpdateCounterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CreateOrUpdateCounterEntity(self._client, opts)
    ...
    def data_get(self) -> CreateOrUpdateCounter:
    ...
    def match_get(self) -> CreateOrUpdateCounter:
    ...
    def create(self, reqdata: CreateOrUpdateCounterCreateData, ctrl=None) -> CreateOrUpdateCounter:
        utility = self._utility
