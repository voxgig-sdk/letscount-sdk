# Letscount SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LetscountSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LetscountSDK(...) and LetscountSDK.test(...) become
#      LetscountSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "letscount_sdk"
_SDK_CLASS = "LetscountSDK"
...
_ENTITIES = {
    "CreateOrUpdateCounter": "create_or_update_counter",
