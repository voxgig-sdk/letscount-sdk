...
class TestDecrementCounterEntity:

    def test_should_create_instance(self):
        testsdk = LetscountSDK.test(None, None)
        ent = testsdk.DecrementCounter(None)
        assert ent is not None

    def test_should_run_basic_flow(self):
        setup = _decrement_counter_basic_setup(None)
...
def _decrement_counter_basic_setup(extra):
    ...
    entity_data_file = os.path.join(_TEST_DIR, "../../.sdk/test/entity/decrement_counter/DecrementCounterTestData.json")
    ...
    _entid_env_raw = os.environ.get(
        "LETSCOUNT_TEST_DECREMENT_COUNTER_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("LETSCOUNT_TEST_DECREMENT_COUNTER_ENTID"))
