...
// Letscount SDK ratelimit feature
...
class LetscountRatelimitFeature extends LetscountBaseFeature
{
    ...
    private function _acquire(LetscountContext $ctx): void
    {
    ...
    private function _track(LetscountContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
