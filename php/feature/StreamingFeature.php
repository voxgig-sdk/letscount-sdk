...
// Letscount SDK streaming feature
...
class LetscountStreamingFeature extends LetscountBaseFeature
{
    ...
    private function _iterate(LetscountResult $result): \Generator
    {
    ...
    private function _streamable(LetscountContext $ctx): bool
    {
