...
class LetscountRbacFeature extends LetscountBaseFeature
{
    ...
    private function _required(LetscountContext $ctx): ?string
    {
    ...
    private function _reject(LetscountContext $ctx, string $required): void
    {
    ...
    private function _track(LetscountContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
