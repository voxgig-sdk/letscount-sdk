...
class LetscountTimeoutFeature extends LetscountBaseFeature
{
    ...
    private function _with_timeout(LetscountContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LetscountContext $_ctx, float $ms): void
    {
        $client = $this->client;
