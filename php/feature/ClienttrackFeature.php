...
// Letscount SDK clienttrack feature
...
class LetscountClienttrackFeature extends LetscountBaseFeature
{
    ...
    public function PostConstruct(LetscountContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Letscount-SDK';
