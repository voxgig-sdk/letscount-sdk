...
class LetscountProxyFeature extends LetscountBaseFeature
{
    ...
    public function init(LetscountContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LetscountContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
