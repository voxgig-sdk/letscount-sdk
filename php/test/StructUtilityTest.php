...
// Letscount SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LetscountOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LetscountOmni::structfix($now, Struct::undef()))
                        !== json_encode(LetscountOmni::structfix($val, Struct::undef()))) {
