...
class LetscountTestRunner
{
    ...
    {
        $live = self::getenv('LETSCOUNT_TEST_LIVE');
        $override = self::getenv('LETSCOUNT_TEST_OVERRIDE');
        ...
        $explain = self::getenv('LETSCOUNT_TEST_EXPLAIN');
...
class_alias('LetscountTestRunner', 'Runner');
class_alias('LetscountHelpers', 'Helpers');
