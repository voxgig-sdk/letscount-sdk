...
// Letscount SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LetscountSDK::test)
...
{
    private const SDK_CLASS = 'LetscountSDK';
    ...
    private const SDK_BASE = 'letscount_sdk';
