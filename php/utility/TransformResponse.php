...
// Letscount SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class LetscountTransformResponse
{
    public static function call(LetscountContext $ctx): mixed
    {
        ...
        $transform = LetscountHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
