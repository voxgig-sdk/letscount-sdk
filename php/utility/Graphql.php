...
class LetscountGraphql
{
    ...
    // equivalent.
    public static function body(LetscountContext $ctx): mixed
    {
    ...
    public static function errors(LetscountContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
