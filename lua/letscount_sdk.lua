...
local LetscountSDK = {}
LetscountSDK.__index = LetscountSDK
...
LetscountSDK._make_feature = _make_feature


function LetscountSDK.new(options)
  local self = setmetatable({}, LetscountSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function LetscountSDK:options_map()
...
function LetscountSDK:get_utility()
  return Utility.copy(self._utility)
end


function LetscountSDK:get_root_ctx()
  return self._rootctx
end


function LetscountSDK:prepare(fetchargs)
...
function LetscountSDK:direct(fetchargs)
...
-- by passing it.
function LetscountSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function LetscountSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "LetscountSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function LetscountSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = LetscountSDK.new(sdkopts)
  sdk.mode = "test"
