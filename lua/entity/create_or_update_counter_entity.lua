-- Letscount SDK CreateOrUpdateCounter entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CreateOrUpdateCounterEntity = {}
CreateOrUpdateCounterEntity.__index = CreateOrUpdateCounterEntity


function CreateOrUpdateCounterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreateOrUpdateCounterEntity)
  self._name = "create_or_update_counter"
  self._client = client
...
function CreateOrUpdateCounterEntity:get_name()
  return self._name
end


function CreateOrUpdateCounterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CreateOrUpdateCounterEntity.new(self._client, opts)
end
...
function CreateOrUpdateCounterEntity:mark_deleted()
  self._deleted = true
end


function CreateOrUpdateCounterEntity:deleted()
  return true == self._deleted
end


function CreateOrUpdateCounterEntity:data_set(args)
  if args ~= nil then
...
function CreateOrUpdateCounterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreateOrUpdateCounterEntity:match_set(args)
  if args ~= nil then
...
function CreateOrUpdateCounterEntity:match_get()
...
function CreateOrUpdateCounterEntity:stream(action, args, callopts)
...
---@param reqdata CreateOrUpdateCounterCreateData
---@param ctrl? table
---@return CreateOrUpdateCounter
---@return string? err
function CreateOrUpdateCounterEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CreateOrUpdateCounterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CreateOrUpdateCounterEntity
