...
local GetCounterEntity = {}
GetCounterEntity.__index = GetCounterEntity


function GetCounterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetCounterEntity)
  self._name = "get_counter"
  self._client = client
...
function GetCounterEntity:get_name()
  return self._name
end


function GetCounterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetCounterEntity.new(self._client, opts)
end
...
function GetCounterEntity:mark_deleted()
  self._deleted = true
end


function GetCounterEntity:deleted()
  return true == self._deleted
end


function GetCounterEntity:data_set(args)
  if args ~= nil then
...
function GetCounterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetCounterEntity:match_set(args)
  if args ~= nil then
...
function GetCounterEntity:match_get()
...
function GetCounterEntity:stream(action, args, callopts)
...
---@param reqmatch GetCounterLoadMatch
---@param ctrl? table
---@return GetCounter
---@return string? err
function GetCounterEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetCounterEntity:_run_op(ctx, post_done)
  local utility = self._utility
