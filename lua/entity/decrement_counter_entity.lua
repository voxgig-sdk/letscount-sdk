...
local DecrementCounterEntity = {}
DecrementCounterEntity.__index = DecrementCounterEntity


function DecrementCounterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DecrementCounterEntity)
  self._name = "decrement_counter"
  self._client = client
...
function DecrementCounterEntity:get_name()
  return self._name
end


function DecrementCounterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DecrementCounterEntity.new(self._client, opts)
end
...
function DecrementCounterEntity:mark_deleted()
  self._deleted = true
end


function DecrementCounterEntity:deleted()
  return true == self._deleted
end


function DecrementCounterEntity:data_set(args)
  if args ~= nil then
...
function DecrementCounterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DecrementCounterEntity:match_set(args)
  if args ~= nil then
...
function DecrementCounterEntity:match_get()
...
function DecrementCounterEntity:stream(action, args, callopts)
...
function DecrementCounterEntity:_run_op(ctx, post_done)
  local utility = self._utility
