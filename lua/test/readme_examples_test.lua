...
local SDK_MODULE = "letscount_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["create_or_update_counter"] = { ["test01"] = { id = "test01" } }, ["decrement_counter"] = { ["test01"] = { id = "test01" } }, ["get_counter"] = { ["test01"] = { id = "test01" } }, ["increment_counter"] = { ["test01"] = { id = "test01" } } } }'
