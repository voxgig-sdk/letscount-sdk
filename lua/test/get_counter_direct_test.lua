...
describe("GetCounterDirect", function()
  it("should direct-load-get_counter", function()
    local setup = get_counter_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_counter", setup.live and "live" or "unit")
