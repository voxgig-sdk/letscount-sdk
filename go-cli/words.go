...
func registerSDKWords(r *eng.Registry, client *sdk.LetscountSDK) {
...
func runOp(client *sdk.LetscountSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
