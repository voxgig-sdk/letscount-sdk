...
The Golang SDK for the Letscount API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/letscount-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/letscount-sdk=../path/to/github.com/voxgig-sdk/letscount-sdk
```
...
```go
// Create
created, _ := client.CreateOrUpdateCounter(nil).Create(
...
| `IncrementCounter` | `(data map[string]any) LetscountEntity` | Create a IncrementCounter entity instance. |
...
```
github.com/voxgig-sdk/letscount-sdk/
...
The root package (`github.com/voxgig-sdk/letscount-sdk`) re-exports everything needed
