...
const testSeed = `map[string]any{"entity": map[string]any{"create_or_update_counter": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "decrement_counter": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_counter": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "increment_counter": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
