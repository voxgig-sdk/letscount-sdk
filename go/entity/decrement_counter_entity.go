...
func NewDecrementCounterEntity(client *core.LetscountSDK, entopts map[string]any) *DecrementCounterEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DecrementCounterEntity) GetName() string { return e.name }
...
func (e *DecrementCounterEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DecrementCounterEntity) Deleted() bool {
	return e.deleted
}


func (e *DecrementCounterEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDecrementCounterEntity(e.client, opts)
}

func (e *DecrementCounterEntity) Data(args ...any) any {
...
func (e *DecrementCounterEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *DecrementCounterEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DecrementCounterEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DecrementCounterEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DecrementCounterEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *DecrementCounterEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *DecrementCounterEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
