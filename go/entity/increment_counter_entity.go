...
type IncrementCounterEntity struct {
	name    string
...
func NewIncrementCounterEntity(client *core.LetscountSDK, entopts map[string]any) *IncrementCounterEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IncrementCounterEntity) GetName() string { return e.name }
...
func (e *IncrementCounterEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IncrementCounterEntity) Deleted() bool {
	return e.deleted
}


func (e *IncrementCounterEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIncrementCounterEntity(e.client, opts)
}

func (e *IncrementCounterEntity) Data(args ...any) any {
...
func (e *IncrementCounterEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *IncrementCounterEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IncrementCounterEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IncrementCounterEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *IncrementCounterEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *IncrementCounterEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IncrementCounterEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
