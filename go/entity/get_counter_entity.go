...
func NewGetCounterEntity(client *core.LetscountSDK, entopts map[string]any) *GetCounterEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetCounterEntity) GetName() string { return e.name }
...
func (e *GetCounterEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetCounterEntity) Deleted() bool {
	return e.deleted
}


func (e *GetCounterEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetCounterEntity(e.client, opts)
}

func (e *GetCounterEntity) Data(args ...any) any {
...
func (e *GetCounterEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetCounter; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetCounterEntity) DataTyped(data ...GetCounter) GetCounter {
	if len(data) > 0 {
		return typedFrom[GetCounter](e.Data(asMap(data[0])))
	}
	return typedFrom[GetCounter](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetCounter (all fields
// optional at the wire level).
func (e *GetCounterEntity) MatchTyped(match ...GetCounter) GetCounter {
	if len(match) > 0 {
		return typedFrom[GetCounter](e.Match(asMap(match[0])))
	}
	return typedFrom[GetCounter](e.Match())
}
...
func (e *GetCounterEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetCounterEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetCounterLoadMatch and returns an GetCounter. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetCounterEntity) LoadTyped(reqmatch GetCounterLoadMatch, ctrl map[string]any) (GetCounter, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetCounter{}, err
	}
	return typedFrom[GetCounter](res), nil
}



func (e *GetCounterEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetCounterEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetCounterEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetCounterEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetCounterEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
