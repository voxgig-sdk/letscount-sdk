...
|---|---|---|
| `ts/` | @voxgig-sdk/letscount-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/letscount-sdk \
      --repository voxgig-sdk/letscount-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/letscount-sdk` shows it, and
`npm trust revoke @voxgig-sdk/letscount-sdk --id=<id>` removes it.
