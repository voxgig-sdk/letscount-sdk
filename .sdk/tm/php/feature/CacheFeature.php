...
class LetscountCacheFeature extends LetscountBaseFeature
{
    ...
    private function _through(LetscountContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
