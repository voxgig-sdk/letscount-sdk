...
// Letscount SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class LetscountMakeRequest
{
    public static function call(LetscountContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new LetscountResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new LetscountResponse($fetched);
        } else {
