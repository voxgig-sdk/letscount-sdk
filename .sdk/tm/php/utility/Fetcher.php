...
// Letscount SDK utility: fetcher

class LetscountFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LetscountSDK/1.0)';
    ...
    public static function call(LetscountContext $ctx, string $fullurl, array $fetchdef): array
    {
