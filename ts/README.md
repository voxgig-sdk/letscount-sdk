# Letscount TypeScript SDK



The TypeScript SDK for the Letscount API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.CreateOrUpdateCounter()` — each with a small set of operations (`load`, `create`, `update`, `remove`)
...
| Method | Returns | Description |
| --- | --- | --- |
| `LetscountSDK.test(testopts?, sdkopts?)` | `LetscountSDK` | Create a test-mode client. |
...
letscount/
├── src/
│   ├── LetscountSDK.ts        # Main SDK class
