...
describe('GetCounterDirect', async () => {
  ...
  test('direct-load-get_counter', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-get_counter', setup.live)) return
    if (skipIfMissingIds(t, setup, ["key01","namespace01"])) return
