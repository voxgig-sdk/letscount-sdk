...
exports.DecrementCounterEntity = void 0;
const LetscountEntityBase_1 = require("../LetscountEntityBase");
// TODO: needs Entity superclass
class DecrementCounterEntity extends LetscountEntityBase_1.LetscountEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'decrement_counter';
        this.name_ = 'decrement_counter';
        this.Name = 'DecrementCounter';
    }
    make() {
        return new DecrementCounterEntity(this._client, this.entopts());
    }
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<DecrementCounterEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.DecrementCounterEntity = DecrementCounterEntity;
//# sourceMappingURL=DecrementCounterEntity.js.map