...
(0, node_test_1.describe)('GetCounterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.LetscountSDK({
    ...
    (0, node_test_1.test)('direct-load-get_counter', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_counter', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["key01", "namespace01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.LetscountSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['LETSCOUNT_TEST_GET_COUNTER_ENTID'];
    ...
    const client = new __1.LetscountSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetCounterDirect.test.js.map