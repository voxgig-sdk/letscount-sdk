...
function envOverride(m) {
    if ('TRUE' === process.env.LETSCOUNT_TEST_LIVE ||
        'TRUE' === process.env.LETSCOUNT_TEST_OVERRIDE) {
    ...
    m.LETSCOUNT_TEST_EXPLAIN = process.env.LETSCOUNT_TEST_EXPLAIN || m.LETSCOUNT_TEST_EXPLAIN;
    return m;
}
