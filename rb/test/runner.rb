...
module LetscountTestRunner
  ...
  def self.env_override(m)
    live = getenv("LETSCOUNT_TEST_LIVE")
    override = getenv("LETSCOUNT_TEST_OVERRIDE")
    ...
    explain = getenv("LETSCOUNT_TEST_EXPLAIN")
    m["LETSCOUNT_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = LetscountTestRunner
Helpers = LetscountHelpers
Vs = VoxgigStruct
