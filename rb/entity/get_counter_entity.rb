...
class GetCounterEntity
  ...
  def make
    opts = @_entopts.dup
    GetCounterEntity.new(@_client, opts)
  end
  ...
  # @return [GetCounter, Hash] the current GetCounter data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetCounter fields)
  def match_get
  ...
  #
  # @param reqmatch [GetCounterLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GetCounter.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GetCounter, Hash] the loaded GetCounter; raises LetscountError on failure
