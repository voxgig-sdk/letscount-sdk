...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/letscount` | `npm install @voxgig-sdk/letscount` |
| Python | `voxgig-sdk-letscount` | `pip install voxgig-sdk-letscount` |
| PHP | `voxgig-sdk/letscount` | `composer require voxgig-sdk/letscount` |
| Golang | `github.com/voxgig-sdk/letscount-sdk/go` | `go get github.com/voxgig-sdk/letscount-sdk/go` |
| Ruby | `voxgig-sdk-letscount` | `gem install voxgig-sdk-letscount` |
| Lua | `voxgig-sdk-letscount` | `luarocks install voxgig-sdk-letscount` |
